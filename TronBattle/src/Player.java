...
class Player implements Cloneable {
    ...
    private DirectionEnum choixDirection(TronGrid tronGrid, List<DirectionEnum> directions) {
        ...
        for (DirectionEnum direction : directions) {
            ...
            for (DirectionEnum directionEnum : DirectionEnum.values()) {
                ...
                if (isValidePosition && tronGrid.get(tmpX, tmpY) == null) {
                    ...
                    throw new IllegalStateException("main.java.TronGrid can't be in this state : " + tronGrid.get(tmpX, tmpY));
                }
            }
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            System.err.println("---");
            myPlayer.scoreMoves(tronGrid, players);
...
abstract class AbstractGrid<T> {
    ...
    protected void printGrid(String nullString) {
...
class ConnectionGrid extends AbstractGrid<ConnectionNode> {
    ...
    public ConnectionGrid(TronGrid tronGrid, List<Player> players, int myId) {
        ...
        //computes connections only from my main.java.Location
...
enum DirectionEnum {
    ...
    boolean isAngleWith(DirectionEnum directionEnum) {
