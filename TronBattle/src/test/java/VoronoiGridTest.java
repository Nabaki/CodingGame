...
public class VoronoiGridTest {
    ...
    public void aloneTest() {
        ...
        resultGrid.debug();
        int resultPoints = resultGrid.countPoints(motocycle0);
    ...
    public void opposed2MotocyclesTest() {
        ...
        int resP0beginPoints0 = resP0beginGrid.countPoints(motocycle0);
        int resP0beginPoints1 = resP0beginGrid.countPoints(motocycle1);
        ...
        int resP1beginPoints0 = resP1beginGrid.countPoints(motocycle0);
        int resP1beginPoints1 = resP1beginGrid.countPoints(motocycle1);
    ...
    public void empty2030GridTest() {
        ...
        resultGrid.debug();
        int resultPoints0 = resultGrid.countPoints(motocycle0);
        int resultPoints1 = resultGrid.countPoints(motocycle1);
